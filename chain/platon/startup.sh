...
platon --identity platon --datadir ~/platon-node/data --port 16789 --rpcport 6789 --rpcapi "db,platon,net,web3,admin,personal" --rpc --nodekey ~/platon-node/data/nodekey --cbft.blskey ~/platon-node/data/blskey --verbosity 1 --rpcaddr 127.0.0.1 --syncmode "fast"
